...
Ext.define('AttendanceManagement.controller.AttendanceController', {
    ...
    ***************************************************************************************** */
     ...
     */
    loadAttendanceStore: function(date, callbackFunction) {
        var me = this;
    ...
    ***************************************************************************************** */
     ...
     *
     * The result should be a copy of the day's attendances into
     * the next day without attendances. The user should be able
     * to press this button repeatedly to fill days into the future.
     */
    onGroupButtonCopy: function(gridView, rowElement, groupName, e) {
        var me = this;
